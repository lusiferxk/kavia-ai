...
import WaitList from '@/components/ui/waitlist-form'
      ...
      <div className="relative">
        <div className="container mx-auto max-w-[1440px] py-[100px] px-0 md:px-[92px] sm:px-0">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-20">
           ...
           <p>  We're excited to bring you our innovative solution soon! Sign up now to secure your spot and get early access when we launch.</p> 
           <p>By joining our waitlist, you'll be among the first to experience our groundbreaking platform. Don't miss out on this opportunity to stay ahead of the curve!</p>
              </div>
