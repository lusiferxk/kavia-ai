...
import EnterpriseFeatures from '@/sections/enterprise/enterprise-features'
import { FeatureSection, featureSectionData } from '@/sections/enterprise/feature-section';
...
export function EnterpriseHero() {
  ...
  const getOrbPositions = (screenSize: string) => {
    ...
    return positions[screenSize as keyof typeof positions] || positions.sm
  }
  ...
  return (
    <section className="bg-[#231F20] relative overflow-hidden">
      ...
      <div className="relative px-4 sm:px-6 md:px-8 lg:px-20 pt-16 sm:pt-20 md:pt-32 lg:pt-48 flex flex-col items-center gap-6 sm:gap-8 md:gap-12 lg:gap-20">
        ...
        <div className="flex flex-col items-center gap-3 relative z-10 w-full max-w-full md:max-w-2xl lg:max-w-4xl">
          ...
          <div className="w-full px-4 sm:px-6 md:px-8 lg:w-[930px] lg:px-0 text-center mt-[0.5px]">
            ...
            <span className="text-white text-base sm:text-lg font-normal font-['Inter'] leading-[30.60px]">
              {' '}
              is an AI-first, cloud-native software development platform - it empowers engineers with intelligent workflows, seamless integrations, and enterprise-grade security, accelerating product delivery.
            </span>
          </div>

          {/* Inspect. Plan. Build. Card */}
          <div className="flex justify-center mt-8 md:mt-12">
            <div className="w-[1256px] h-[392px] relative bg-[#151313] rounded-[40px] overflow-hidden">
              <div className="w-full h-[101px] left-0 top-[454px] absolute bg-gradient-to-b from-[#312d2b]/20 to-[#161314]/20" />
              <div className="w-[496px] h-[102px] left-1/2 top-[177px] -translate-x-1/2 absolute bg-[#f26a1b] rounded-full blur-[257px]" />
              <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 inline-flex flex-col justify-start items-center gap-8">
                <div className="self-stretch flex flex-col justify-start items-start gap-3">
                  <div className="self-stretch text-center justify-start text-white text-5xl font-medium font-['Inter'] leading-[62.40px]">Inspect. Plan. Build.</div>
                  <div className="w-[514px] text-center justify-start text-[#dedcdd] text-base font-normal font-['Inter'] leading-normal">Transform Enterprise Software Development Process with KAVIA AI</div>
                </div>
                <button className="h-10 px-5 py-1.5 bg-[#f26a1b] rounded-[6px] inline-flex justify-center items-center gap-2 hover:bg-[#e15e0d] transition-colors cursor-pointer">
                  <span className="justify-center text-white text-sm font-semibold font-['Inter'] leading-tight">Get started with KAVIA AI</span>
                </button>
              </div>
            </div>
          </div>
        ...
        <FeatureSection {...featureSectionData.integration} />
        <FeatureSection {...featureSectionData.collaboration} />
        <FeatureSection {...featureSectionData.support} isLastSection />
        </div>
      </div>
    </section>
  )
